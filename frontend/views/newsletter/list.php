...
<section class="contact-form newsletter-list-page">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form role="search" method="get" class="search-form mb-5" action="<?php echo Yii::$app->urlManager->createAbsoluteUrl(['newsletter/list']) ?>">
                    <label class="d-block">                        
        ...
        <?php if (count($newsletterList)) { ?>

            <div class="row">
                <?php foreach ($newsletterList as $k => $news) { ?>

                    <div class="col-lg-4 col-md-6">
                        <div class="blog-box">
                            <a href="<?php echo $news->getDetailUrl() ?>">
                                <div class="image">
                                    <img src="<?php echo $news->getCoverImageUrl() ?>" alt="Newsletter-Image">
                                </div>
                            </a>
                            <div class="content">
                                <a href="<?php echo $news->getDetailUrl() ?>">
                                ...
                                <ul class="d-flex align-item-center">
                                    <li>
                                        <a href="javascript:void(0)">
                                            ...
                                            <?php echo $news->getCreatedByName(); ?> 
                                    ...
                                    <li>
                                        <a href="javascript:void(0)">
                                            ...
                                            <?php echo date('M d, Y', $news->created_at) ?>
                                        </a>
                                    </li>
                                </ul>
                                <p class="text-justify">
                                    <?php echo mb_strimwidth($news->short_description, 0, 120, " ..."); ?>
                                </p>
                                <a href="<?php echo $news->getDetailUrl() ?>" class="read-more">read more</a>
                            </div>
                        </div>
                    </div>
                <?php } ?>
