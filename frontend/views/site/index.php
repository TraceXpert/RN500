...
<section class="industry-logo">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-4 col-6">
                <img src="<?= $assetDir ?>/img/14.jpg" alt="about-us" class="img-fluid mx-auto d-block">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
                <img src="<?= $assetDir ?>/img/15.jpg" alt="about-us" class="img-fluid mx-auto d-block">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
                <img src="<?= $assetDir ?>/img/16.png" alt="about-us" class="img-fluid mx-auto d-block">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
                <img src="<?= $assetDir ?>/img/17.jpg" alt="about-us" class="img-fluid mx-auto d-block">
            </div>
            <div class="col-lg-2 col-md-4 col-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 offset-lg-1 col-md-4 col-6">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 18848]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg> New York
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 6436]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg> Dallas
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 20888]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Phoenix
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 23637]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>San Francisco
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 24075]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Seattle
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 17085]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Miami
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 4833]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Chicago
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 631]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Anchorage
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 23630]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>San Diego
            ...
            <div class="col-lg-3 offset-lg-1 col-md-4 col-6">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 14564]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Las Vegas 
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 12517]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Houston
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 18413]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Nashville
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 27945]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Washington
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 1114]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Atlanta
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 2744]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Boston 
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 7973]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>El Paso
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 17472]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Minneapolis
                    ...
                    <li>
                        <a href="<?= Yii::$app->urlManagerFrontend->createAbsoluteUrl(['browse-jobs/index', 'location[]' => 19704]) ?>" class="popular-location">
                            <svg class="mr-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <circle cx="15" cy="15" r="15" fill="#DADADA"/>
                            <path d="M13.9375 9.09375C13.625 9.40625 13.6562 9.875 13.9375 10.1875L17.7188 13.75H8.75C8.3125 13.75 8 14.0938 8 14.5V15.5C8 15.9375 8.3125 16.25 8.75 16.25H17.7188L13.9375 19.8438C13.6562 20.1562 13.6562 20.625 13.9375 20.9375L14.625 21.625C14.9375 21.9062 15.4062 21.9062 15.6875 21.625L21.7812 15.5312C22.0625 15.25 22.0625 14.7812 21.7812 14.4688L15.6875 8.40625C15.4062 8.125 14.9375 8.125 14.625 8.40625L13.9375 9.09375Z" fill="white"/>
                            </svg>Oklahoma City
