    ...
    <div class="col-md-12">
        ...
        <nav>
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active" data-toggle="tab"   id="nav-tab-we"  role="tab" aria-controls="nav-home" aria-selected="true" href="#tab-work-experience">Work Experience</a>
                ...
                <a class="nav-item nav-link" data-toggle="tab" id="nav-tab-doc"   role="tab" aria-controls="nav-profile" aria-selected="false" href="#tab-documents">Documents</a>
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active" id="tab-work-experience" role="tabpanel" >
