...
class Education extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['degree_name', 'year_complete', 'institution', 'location'], 'match', 'not' => true, 'pattern' => Yii::$app->params['NO_HTMLTAG_PATTERN'], 'message' => Yii::t('app', Yii::$app->params['HTMLTAG_ERR_MSG'])],
        ];
    }
