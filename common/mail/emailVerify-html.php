...
<!--<tr>
    <td style="padding: 0px 30px 20px;font-family: 'Montserrat', sans-serif;font-size: 24px;">
        <h3 style="margin: 40px 0 0;font-weight: 600;color: #3362cc">Dear <?= Html::encode($name) ?>,</h3>
    </td>
</tr>
...
<tr>
    <td  style="padding: 0px 30px 20px;">
        <a href="<?= $resetLink ?>"  style="text-decoration: none;color: #FFF;padding: 16px 30px;background:#4485ea;font-weight: 500;text-align: center;cursor: pointer;display: inline-block;border-radius: 4px;font-family: 'Montserrat', sans-serif;margin: 10px 0px">
            VERIFY EMAIL
        </a>
    </td>
</tr>
                            ...
                            <tr>
                                <td style="padding: 20px">
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        <tr
                                            style="background: #2470b3;border-radius: 6px;padding: 20px;display: grid;">
                                            <td align="left">                            
                                                <div
