                            ...
                            <tr>
                                <td style="padding: 20px">
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="padding: 10px 20px;color: #000000;font-weight: 500;font-family: 'Montserrat', sans-serif;text-align: justify;font-size: 16px;line-height: 26px;">
                                                Application of Job Seeker has been accepted. Please contact on Email: <?php echo $employerCompany->company_email; ?>, Phone: <?php echo $employerCompany->company_mobile; ?>, Name: <?php echo $employerBranch->getOwnerName() ?> for further process. 
                                            </td>
                                        </tr>
