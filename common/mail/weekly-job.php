                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td align="left" style="padding: 0px 20px 20px;display: flex;">
                                                <span
                                                    style="color: #000000;font-weight: 500;font-family: 'Montserrat', sans-serif;font-size: 16px;font-weight: 600;margin-right: 10px;display: flex;align-items: center;">Stay
                                                    in touch</span>
