                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <p
                                                                    ...
                                                                    Hello <?php echo $model->to_name ?>, <br />
                                                                </p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <tr>
                                            <td style="padding: 40px 20px;color: #000000;font-weight: 500;font-family: 'Montserrat', sans-serif;text-align: justify;font-size: 16px;line-height: 26px;">
                                                You are invited by <b> <?php echo $model->from_name ?></b> ( <?php echo $model->from_email ?>) to review or apply following job, please click on below link. 
                                            </td>
                                        </tr>

                                        <tr>
                                            <td align="left" style="padding: 0px 20px;">
                                                <a href="<?= $referralLink ?>" style="text-decoration: none;color: #FFF;padding: 16px 20px;background:#2470b3;font-weight: 500;text-align: center;cursor: pointer;display: inline-block;border-radius: 6px;font-family: 'Montserrat', sans-serif;">
                                                    CLICK HERE 
                                                </a>
                                            </td>
                                        </tr>
