                                    ...
                                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                                        ...
                                        <tr>
                                            <td style="padding: 20px 20px;color: #000000;font-weight: 500;font-family: 'Montserrat', sans-serif;text-align: justify;font-size: 16px;line-height: 26px;">
                                                Thank you for applying Job Title: <?php echo $lead->title ?>,   Job Reference No.: <?php echo $lead->reference_no ?>, for location: <?php echo $lead->getLocation() ?>. Recruiter has received your application. You will be hear back from Recruiter within 24 to 48 hours for further process once your application is selected. 
                                            </td>
                                        </tr>

                                        <tr>
                                            <td style="padding: 10px 20px;color: #000000;font-weight: 500;font-family: 'Montserrat', sans-serif;text-align: justify;font-size: 16px;line-height: 26px;">
                                                Once again Thank you for apply and best of luck. 
                                            </td>
                                        </tr>
