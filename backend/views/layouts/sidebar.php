...
//                    ],
                    [
                        ...
                        'url' => ['banner/index'],
                        'icon' => 'newspaper',
                        'active' => ($controller == "banner"),
                        'visible' => isset(Yii::$app->user->identity) ? CommonFunction::checkAccess('banner-create', Yii::$app->user->identity->id) || CommonFunction::checkAccess('banner-update', Yii::$app->user->identity->id) || CommonFunction::checkAccess('banner-delete', Yii::$app->user->identity->id) || CommonFunction::checkAccess('banner-view', Yii::$app->user->identity->id) : false
                    ],
                        [
                        'label' => 'Branch',
